...
var space = function space() {
  return _objectSpread(_objectSpread({}, new _token["default"]("text", "", 0)), {}, {
    content: " "
  });
};
...
var renderAnchorLinkSymbol = function renderAnchorLinkSymbol(options) {
  if (options.anchorLinkSymbolClassName) {
    return [_objectSpread(_objectSpread({}, new _token["default"]("span_open", "span", 1)), {}, {
      attrs: [["class", options.anchorLinkSymbolClassName]]
    }), _objectSpread(_objectSpread({}, new _token["default"]("text", "", 0)), {}, {
...
var renderAnchorLink = function renderAnchorLink(anchor, options, tokens, idx) {
  ...
  var openLinkToken = _objectSpread(_objectSpread({}, new _token["default"]("link_open", "a", 1)), {}, {
    attrs: attrs
  });
...
function _default(md, options) {
  ...
  md.core.ruler.push("init_toc", function (state) {
    ...
    var tocMarkdown = "";
    var tocTokens = [];
    var slugifyFn = typeof options.slugify === "function" && options.slugify || slugify;
